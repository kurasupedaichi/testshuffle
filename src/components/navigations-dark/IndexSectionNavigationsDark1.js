...
export default function IndexSectionNavigationsDark1() {
    return (
        <React.Fragment>
            <>
    ...
    <div className="flex justify-between items-center w-full">
      <div className="hidden xl:flex w-1/3">
        <ul className="flex w-full">
          ...
          <li className="mr-12"><a className="text-coolGray-400 hover:text-coolGray-50 font-medium" href="#">Pricing</a></li>
          <li><a className="text-coolGray-400 hover:text-coolGray-50 font-medium" href="#">Resources</a></li>
        </ul>
      </div>
      <div className="w-auto xl:w-1/3">
        <a className="flex xl:justify-center max-w-max mx-auto" href="#">
          <img className="h-8" src="flex-ui-assets/logos/flex-ui-green.svg" alt />
        </a>
      </div>
      <div className="hidden xl:block w-1/2 xl:w-1/3">
        <div className="flex items-center justify-end"><a className="inline-block py-2 px-4 mr-2 leading-5 text-coolGray-400 hover:text-coolGray-50 bg-transparent font-medium rounded-md" href="#">Log In</a><a className="inline-block py-2 px-4 text-sm leading-5 text-green-50 bg-green-500 hover:bg-green-600 font-medium focus:ring-2 focus:ring-green-500 focus:ring-opacity-50 rounded-md" href="#">Sign Up</a></div>
      </div>
    </div>
